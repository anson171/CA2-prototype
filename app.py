...
FEATURES = ['Manufacture_Year', 'Mileage_km', 'Horsepower_PS', 'Brand']         # Example: ["Manufacture_Year", "Mileage_km"]
...
st.title("HK Used Car Price Estimator — MoYuHin_250139770_CA2 Prototype")                  #<- Change your name here!!!=======================================
